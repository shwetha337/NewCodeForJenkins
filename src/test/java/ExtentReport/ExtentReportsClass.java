...
public class ExtentReportsClass {
	...
	public void ASMShippingwithAzureO365(String url, String name) throws IOException, InterruptedException, IllegalFormatException, FindFailed, NoSuchSessionException, AWTException {
...
*/
	...
	public void basicsetuphttps(String url, String name) throws IllegalFormatException, IOException, InterruptedException, NoSuchSessionException, AWTException{
	  ...
	  //THis method will save the file to the current directory
		...
		pattern2=new Pattern(".\\sikuliximage-1611644195777.png");
		...
		pattern3=new Pattern(".\\sikuliximage-1611644203721.png");
	...
	public void basicSetupForGodigit(String url, String name) throws IllegalFormatException, IOException,TimeoutException,InterruptedException,NoSuchSessionException{
		...
		pattern1=new Pattern(".\\sikuliximage-1611813119992.png");
		Thread.sleep(1000);
		try {
			Thread.sleep(1000);
			scr.click(pattern1);
		...
		System.out.println(path2);*/
		Pattern pattern2 = null;
		pattern2=new Pattern(".\\sikuliximage-1611813137115.png");
	...
	/*	ScreenImage scrImgFile3 = scr.userCapture();
		...
		System.out.println(path3);*/
		Pattern pattern3 = null;
		pattern3=new Pattern(".\\sikuliximage-1611813141701.png");
